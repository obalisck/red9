...
# All other languages are inherited from English to ensure we don't miss entries
import Red9.startup.language_packs.language_english as language_english
...
class LockChannelsUI(language_english.LockChannelsUI):
    title = 'LockChannels'
...
class SearchNodeUI(language_english.SearchNodeUI):
    '''
...
class Mirror_Setup(language_english.Mirror_Setup):
    title = "MirrorSetup"
    side = 'MirrorSide:'
    index = 'MirrorIndex:'
    axis = 'MirrorAxis:'
